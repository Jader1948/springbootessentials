...
class AnimeServiceTest {
    ...
    @Test
    @DisplayName("ListAll returns list of anime insede page object when successful")
    ...
    void findByIdOrThrowBadRequestException_throwsBadRequestException_WhenAnimeNotFound() {
        ...
        Assertions.assertThatExceptionOfType(BadRequestExcepition.class)
    ...
    @Test
    @DisplayName("FindByName returns  an empty list of animes when is not found")
